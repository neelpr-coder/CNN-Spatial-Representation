...
def load_decoding_targets(
    ...
    """
    Produce coordinates as targets for training/testing from images captured from Unity.
...
def load_full_dataset_model_reps(
    ...
    # use model output
        ...
        if 'vit' in config['model_name']:
            ...
            model_reps = model.predict(preprocessed_data, verbose=1, batch_size=64)
